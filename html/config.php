            ...
            <div class="content">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading"><b><font size=5>Configurações</font></b></div>
...
$query = sprintf("SELECT nome, email FROM email");
// executa a query
...
?>
<button type=button class= btn btn-info onclick='document.location="cadastro_email.php" '><b>Inserir e-mail</b></button>
 ...
 <thead>
<?php
        echo "<tr><th>Nome:</th><th>Email:</th><th>Opção:</th></tr>";
        // se o número de resultados for maior que zero, mostra os dados
        if($total > 0) {
                // inicia o loop que vai mostrar todos os dados
                do {
                        echo "<tr><td>".$linha['nome']."</td> <td>".$linha['email']."</td><td><button type=\"button\" class=\"btn btn-info\" onclick='document.location=\"exclui_email.php?email=".$linha['email']."\" '>Excluir</button></td></tr>";
                        ?>
