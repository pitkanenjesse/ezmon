<!DOCTYPE html>
 <!-- Página em que são exibidos os servidores -->
<?php
            ...
            <div class="content">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading"><b><font size=5>Servidores</font></b></div>
...
$query = sprintf("SELECT id_servidor, nome_servidor, ip FROM servidores");
// executa a query
...
<body>
 ...
 <thead>
<button type=button class= btn btn-info onclick='document.location="cadastro_servidor.php" '><b>Inserir servidor</b></button>
<?php
        echo "<tr><th>Nome:</th><th>Link:</th><th>Opção:</th></tr>";
        ...
        if($total > 0) {
                ...
                do {
                        ...
                        echo "<tr><td>".$linha['nome_servidor']."</td><td>".$linha['ip']."</td> </td><td><button type=\"button\" class=\"btn btn-info\" onclick='document.location=\"exclui_servidor.php?ip=".$linha['ip']."\" '>Excluir</button></td></tr>";                
                ?>
